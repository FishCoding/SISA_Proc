...
.set PILA, 0x6000               ;una posicion de memoria de una zona no ocupada para usarse como PILA
...
.text
        movi r6, 0
        div r6, r6, r6 ;produce division /0	

        $MOVEI r6,0xC120
        st      0(r6),r6 ; Acceso a memoria 

        rds r6,s1

        halt ; añadimos un halt para identificarlo rapido, una vez compilado se substituye por FFFE (instr. ilegal)	
	    movi r6, 0
	    ld r6, 0(r6) ; provoca direccion no alineada
